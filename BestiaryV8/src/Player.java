...
public class Player {
    ...
    private Map<String, Bait> baitBestiaryRegistered;
    private Map<String, Fish> fishBestiaryRegistered;
    private Map<String, Enemy> enemyBestiaryRegistered;
    private Map<String, Enemy> bossBestiaryRegistered;
    ...
    public Player() throws IOException {
        ...
        playerOptions.add("View Inventory");
        ...
        baitBestiaryRegistered = new TreeMap<String, Bait>();
        fishBestiaryRegistered = new TreeMap<String, Fish>();
        enemyBestiaryRegistered = new TreeMap<String, Enemy>();
        bossBestiaryRegistered = new TreeMap<String, Enemy>();
        ...
        if(file.exists()) {
            ...
            line = fileReader.nextLine();
            storedMoney = Integer.parseInt(line);
            ...
            if(line.equals("")) {
                ...
                while(tokenizer.hasMoreTokens()) {
                    String currentToken = tokenizer.nextToken();
                    currentArmor = CONST.getArmorMap().get(currentToken);
                }
            }
            ...
            while(tokenizer.hasMoreTokens()) {
                String currentToken = tokenizer.nextToken();
                baitBestiaryRegistered.put(currentToken, CONST.getBaitMap().get(currentToken));
            }
            ...
            while(tokenizer.hasMoreTokens()) {
                String currentToken = tokenizer.nextToken();
                fishBestiaryRegistered.put(currentToken, CONST.getFishMap().get(currentToken));
            }
            ...
            while(tokenizer.hasMoreTokens()) {
                String currentToken = tokenizer.nextToken();
                enemyBestiaryRegistered.put(currentToken, CONST.getEnemyMap().get(currentToken));
            }
            ...
            while(tokenizer.hasMoreTokens()) {
                String currentToken = tokenizer.nextToken();
                bossBestiaryRegistered.put(currentToken, CONST.getBossMap().get(currentToken));
            }
        }
    }
    ...
    public void save() throws IOException {
        ...
        if(currentArmor == null) {
            ...
            line = "";
            line += "" + currentArmor.getName().toLowerCase() + "";
            saveFile.println(line);
        }

        line = "";
        iter = baitBestiaryRegistered.keySet().iterator();
        while(iter.hasNext()) {
            line += iter.next();
            if(iter.hasNext())
                line += ",";
        ...
        line = "";
        iter = fishBestiaryRegistered.keySet().iterator();
        while(iter.hasNext()) {
            line += iter.next();
            if(iter.hasNext())
                line += ",";
        ...
        line = "";
        iter = enemyBestiaryRegistered.keySet().iterator();
        while(iter.hasNext()) {
            line += iter.next();
            if(iter.hasNext())
                line += ",";
        ...
        line = "";
        iter = bossBestiaryRegistered.keySet().iterator();
        while(iter.hasNext()) {
            line += iter.next();
            if(iter.hasNext())
                line += ",";
    ...
    public Map<String, Bait> getBaitBestiaryRegistered() {
        return baitBestiaryRegistered;
    }

    public Map<String, Fish> getFishBestiaryRegistered() {
        return fishBestiaryRegistered;
    }

    public Map<String, Enemy> getEnemyBestiaryRegistered() {
        return enemyBestiaryRegistered;
    }

    public Map<String, Enemy> getBossBestiaryRegistered() {
        return bossBestiaryRegistered;
    }
